...
## Use 'perldoc burntrees-c2b.pl' or see the end of file for description.
...
## Globals
my $scriptname         = $0;
my $VERSION            = '0.3.0 c2b';
my $CHANGES            = 'mon 2 okt 2017 14:24:56';
...
#===  FUNCTION  ================================================================
#         NAME: time2brlen
#      VERSION: 10/04/2017 03:45:06 PM
#  DESCRIPTION: Transform branch lengths from time units to substitutions per site
#   PARAMETERS: tree string
#      RETURNS: tree string
#===============================================================================
sub time2brlen {
    ...
    ## Iterate over tree and substitute all branch lengths (ages) with effectivebrlenIgrBrlens:
    $tree =~ s/:(\d+\.?\d*([eE][+-]?\d+)?)(\[.+?effectivebrlenIgrBrlens\{\w+\}_mean=(\d+\.?\d*([eE][+-]?\d+)?),.+?\])/:$4$3/ig;
...
#===  POD DOCUMENTATION  =======================================================
#      VERSION: 10/04/2017 03:44:57 PM
...
Documentation for burntrees-c2b.pl version 0.3.0


=head1 SYNOPSIS

burntrees.pl [--c2b] [--r2b=<number>] [--burnin=<number>] [--pburnin=<number>] [--start=<number>] [--end=<number>] [--jump=<number>] [--IFeelLucky=<number>] [--treesonly] [--rmbrlens] [--rmcomments] [--rmsupport] [--sci2norm=<nr>] [--myr] [--[no]close] [--getinfo] [--[no]labels] [--format=altnexus|phylip] [--outfile=<file_name>] FILE [> OUTPUT]
...
Change the MrBayes clock branch length format from time units to expected number of substitutions per site.
...
=item B<-r2b, --r2b=>I<number>

Transform branch lengths from time units to susbst. per site given an average clockrate for the tree. 
...
To change the MrBayes clock branch length format from time units to substitutions per site, use

  ./burntrees-c2b.pl --c2b clock.con.tre
  ./burntrees-c2b.pl --c2b --rmcomments clock.con.tre
